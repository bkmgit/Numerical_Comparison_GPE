function CN(Simplices::Array{Int64,2}, 
...
Energy[1,1] = real(U0'*(A*U0)+β*U0'*(M_b*U0)/2.0)   #Energy is calculated here
Energy[1,2] = 0.0
...
U,Energy = TimeStep_CN(Simplices,Nodes,Mesh2Space,N_of_Simplices,N_of_Nodes,tau,N_t,A,M,M_v,U0,Energy,SpaceSize,Quad,v,E);

Tid = time()-Tid
save(pathway*"CN_beta"*string(β)*"_Nt_"*string(N_t)*"_Mesh_"*string(Mesh)*".jld","U",U,"Energy",Energy,"Mesh2Space",Mesh2Space,"beta",β,"Tid",Tid)
